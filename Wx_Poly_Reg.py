...
Station_data_file_path = "Data/LouisvilleDailyWxSummary.csv" # Data/KIAD_Station_data.txt  Data/LouisvilleDailyWxSummary.csv
...
observation_start_date = pd.to_datetime("1948-5-1") #for if the observation begins at any other time than the beginning of the dataset
target_forecast = 3
...
fit_model_poly = poly_features.fit_transform(fit_model)

lin_reg = LinearRegression()

scores = cross_val_score(lin_reg, fit_model_poly[target_forecast:], model_labels[target_forecast:], 
